Util.require('https://maps.googleapis.com/maps/api/js?key=AIzaSyB7RD2Tkys80CNXVDITEDkow5V2uwqH-hU&callback=initMap');
...
// 1. 지도를 보여주고 현재 위치 찾기
var map;
// Location.search : '?' 문자 뒤 URL의 쿼리스트링을 값으로 하는 DOMString입니다. 
...
function initMap(){
  ...
  var mapOptions = {
    center: {lat: 37.527232, lng: 127.028439},
    zoom: 14
  };
